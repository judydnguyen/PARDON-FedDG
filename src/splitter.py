...
# This class is used to generate domain-based client heterogeneity
...
class NonIIDSplitter():
    ...
    def split(self, dataset, domain_field, transform=None, dataset_name="pacs"):
        '''
        dataset: WILDSSubset
        '''            
        ...
        # with open(f"stats/{dataset.split_scheme}_{self.iid}_{self.num_shards}_{dataset_name}.csv", "w+") as wf:
        #     writer = csv.writer(wf)
        #     writer.writerows(final_examples_per_shards)
